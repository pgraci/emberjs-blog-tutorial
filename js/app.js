...
var albums = [
  ...
  },
  {
    ...
    image: "images/studio-one-story-full.jpg"
  },
  {
    id: 3,
    ...
    excerpt: "Dub Specialist is a name used for a series of limited edition 1970s Dub LP releases from Coxone Dodds Studio One label.",
    body: "The relationship between Bostons Heartbeat label and Clarence Coxsone Dodds Studio One label has yielded to American audiences a treasure trove of previously hard-to-find roots reggae. The tradition continues, in a slightly different mode, with this interesting collection of dub versions based on tracks from the Studio One vaults. What makes it interesting is that the dubs themselves are not period pieces -- they are modern realizations by an engineer coyly identified only as the Dub Specialist (whom one is tempted to identify as Heartbeat label head Chris Wilson). Whoever it is, he doesnt have quite the same genius as that which animated the best dub artists of the 1970s; where King Tubby or Augustus Pablo would have made artful use of drop-out, delay, and echoing cross-rhythms, whoever was at the board for these mixes satisfied himself mainly with the random imposition of echo. Its not a bad sound, and heaven knows the rhythms are excellent (and their original versions are helpfully identified in the liner notes). But it doesnt amount to anything like essential dub. (For that, check out the two-disc set Dub Over Dub, also on Heartbeat, and featuring the mixing talents of Errol Brown on singles culled from the vaults of Sonia Pottinger.)",
    image: "images/dub-shots-from-studio-one-full.jpg"
  }
];
